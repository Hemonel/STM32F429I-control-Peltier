#ifndef VARIASGRAFICAS_H
#define VARIASGRAFICAS_H
...
class VariasGraficas : public QWidget {
    ...
    QLineSeries ** puntosIzquierda, ** puntosDerecha;
    ...
    QValueAxis * ejeX, * ejeYIzquierdo, * ejeYDerecho;
...
public:
    ...
    // Añade nuevos puntos, todos con la misma coordenada X. En valoresIzquierda se pasa la
